...
// CONCATENATED MODULE: ./src/components/GridItem.vue?vue&type=template&id=686d347b&
...
/*: number*/
{
  ...
  for (var _i2 = 0, len = layout.length; _i2 < len; _i2++) {
    yList.push(layout[_i2].y);
  }

  var temp = new Set(yList);
  return temp.size;
}
function rowIndex(layout
/*: Layout*/
, layoutItem
/*: LayoutItem*/
)
...
{
  if (!layout) return;
  var rowsByIndex = layout.filter(function (item) {
    return item.x === layoutItem.x;
  });
  rowsByIndex.sort(function (a, b) {
    return a.y - b.y;
  });
  return rowsByIndex.findIndex(function (item) {
    return item.y === layoutItem.y;
  });
}
...
/*: Layout*/
{
  ...
  for (var _i3 = 0, len = layout.length; _i3 < len; _i3++) {
    newLayout[_i3] = cloneLayoutItem(layout[_i3]);
  }
...
/*: Layout*/
{
  ...
  for (var _i4 = 0, len = sorted.length; _i4 < len; _i4++) {
    var l = sorted[_i4]; // Don't move static elements
...
/*: Layout*/
{
  ...
  for (var _i8 = 0, len = collisions.length; _i8 < len; _i8++) {
    var collision = collisions[_i8]; // console.log('resolving collision between', l.i, 'at', l.y, 'and', collision.i, 'at', collision.y);
  ...
  for (var _i9 = 0, len = layout.length; _i9 < len; _i9++) {
    ...
    for (var j = 0; j < subProps.length; j++) {
      if (typeof item[subProps[j]] !== 'number') {
        throw new Error('VueGridLayout: ' + contextName + '[' + _i9 + '].' + subProps[j] + ' must be a number!');
      }
    }
    ...
    if (item.static !== undefined && typeof item.static !== 'boolean') {
      throw new Error('VueGridLayout: ' + contextName + '[' + _i9 + '].static must be a boolean!');
    }
  }
    ...
    calcPosition: function calcPosition(x, y, w, h) {
      ...
      if (this.renderRtl) {
        ...
        out = {
          ...
          top: Math.round(this.rowHeight * y + rowIndex(this.layout, {
            x: x,
            y: y,
            w: w,
            h: h
          }) * this.margin[1] + (this.customizeInner ? +this.placeholderHeight * rowIndex(this.layout, {
            x: x,
            y: y,
            w: w,
            h: h
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules//.cache//vue-loader","cacheIdentifier":"d988afac-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/GridLayout.vue?vue&type=template&id=8fc6497c&
var GridLayoutvue_type_template_id_8fc6497c_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{ref:"item",staticClass:"vue-grid-layout",style:(_vm.mergedStyle)},[_vm._t("default"),_c('grid-item',{directives:[{name:"show",rawName:"v-show",value:(_vm.isDragging),expression:"isDragging"}],staticClass:"vue-grid-placeholder",attrs:{"x":_vm.placeholder.x,"y":_vm.placeholder.y,"w":_vm.placeholder.w,"h":_vm.placeholder.h,"i":_vm.placeholder.i}})],2)}
var GridLayoutvue_type_template_id_8fc6497c_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/GridLayout.vue?vue&type=template&id=8fc6497c&
  ...
  methods: {
    ...
    layoutUpdate: function layoutUpdate() {
      if (this.layout !== undefined) {
        ...
        this.eventBus.$emit("compact", this.layout);
        this.eventBus.$emit("updateWidth", this.width);
        this.updateHeight();
      }
    },
    ...
    containerHeight: function containerHeight() {
      ...
      return bottom(this.layout) * (this.rowHeight + this.margin[1]) + this.margin[1] + maxRows(this.layout) * (this.placeholderHeight || 0) + "px";
    },
...
var GridLayout_component = normalizeComponent(
  ...
  GridLayoutvue_type_template_id_8fc6497c_render,
  GridLayoutvue_type_template_id_8fc6497c_staticRenderFns,
  false,
  null,
  null,
  null
